...
import { LayoutDashboard, CalendarDays, ListTodo, BellRing, Settings, Video, Heart } from 'lucide-react';
        ...
        {navItems.map((item) => {
            ...
            return (
              <button
                ...
                className={`relative p-4 rounded-2xl transition-all duration-300 min-w-[3.5rem] flex items-center justify-center ${
